      ...
      <div className="flex gap-6 flex-wrap justify-between max-w-screen-2xl mx-auto min-h-[80vh] px-2">
        <section className="flex-1 flex flex-col gap-8">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6 text-gray-500 dark:text-gray-400 max-w-2xl">
            ...
            earum modi porro accusantium vel vero velit, ipsa provident laborum,
            molestiae ea autem consectetur, explicabo similique deserunt. Ab nam
            corporis maiores?
          </p>
        ...
        <section className="flex-1 relative px-4 pt-10">
          ...
          <figure className="w-44 h-44 overflow-hidden rounded-full bg-white dark:bg-black relative z-10 p-4 ml-6">
